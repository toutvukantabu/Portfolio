        ...
        <section className="flex items-center justify-center min-h-screen px-6 bg-zinc-900/80 backdrop-blur-sm">
            <div className="max-w-6xl w-full mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-12 items-center">
                    {/* Partie Cal.com */}
                    <div className="h-[600px] p-8 border border-green-400/20 rounded-xl bg-black/30
                                    hover:border-green-400/40 transition-all duration-300 shadow-lg">
                        ...
                        <iframe
                            ...
                            style={{
                                width: "100%",
                                height: "450px", // ✅ Hauteur agrandie pour éviter le scroll
                                border: "none",
                                borderRadius: "8px",
                                overflow: "hidden"
                            }}
